...
import { IStatePlayer, IResponsePlayerSelected } from "../interfaces/players.interface";
export default defineComponent({
  ...
  setup() {
    ...
    const getPlayerValues = (id:number) =>{
      ...
      //  isOpen.value = true;
       console.log(playersStore.isOpen);
       playersStore.isOpen = true;
      getPlayerSelected(id) .then((res: IResponsePlayerSelected[]) => {        
        console.log(res);
